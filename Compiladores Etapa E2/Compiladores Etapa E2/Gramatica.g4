...
metaexpr returns [ string tipo ]
    ...
    | l=metaexpr TOK_CMP_EQ_DIFF r=metaexpr 
	{
		$tipo = "bool";
	}      #me_booleqdiff_rule     // == and != are egual
    | l=metaexpr TOK_BOOL_AND r=metaexpr  
	{
		$tipo = "bool";
	}        #me_bool_and_rule      // &&
    | l=metaexpr TOK_BOOL_OR r=metaexpr  
	{
		$tipo = "bool";
	}         #me_bool_or_rule      // ||
...
literal returns [string tipo]
    ...
    |   FLOAT    {$tipo = "float"; }          #literal_float_rule
    |   DECIMAL          {$tipo = "int";}  #literal_decimal_rule
    |   HEXADECIMAL      {$tipo = "int";}  #literal_hexadecimal_rule
    |   BINARY           {$tipo = "int";}  #literal_binary_rule
    |   TOK_STR_LIT       {$tipo = "char";} #literalstring_rule
    |   TOK_CHAR_LIT       {$tipo = "char";} #literal_char_rule
    ;
